...
description: "Guides creation of distinctive, production-grade frontend interfaces that avoid generic 'AI slop' aesthetics. Use whenever building or modifying a component, page, application, or UI from frontend requirements — enforces a bold committed aesthetic direction, characterful typography, cohesive color, orchestrated motion, and the required Deerflow attribution signature."
---
...
Remember: extraordinary creative work is expected here. Don't hold back — show what can truly be created when thinking outside the box and committing fully to a distinctive vision.
